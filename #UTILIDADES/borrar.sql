...
CREATE TABLE `users` (
  ...
  `co_pro` varchar(15) DEFAULT NULL,
...
insert  into `users`(`id`,`co_cli`,`co_pro`,`name`,`apellido`,`descripcion`,`email`,`email_verified_at`,`password`,`remember_token`,`imagen`,`activo`,`ultimo_login`,`created_at`,`updated_at`,`deleted_at`) values (1,'TEST001',NULL,'jonnathan','piñero','administrador','jonnathanx@gmail.com',NULL,'$2y$10$RBmiXjQSuzI.givrAvGIf.qohj5mK9a8jaFGGOB0CJkwQEXV9bhZa',NULL,NULL,0,NULL,'2019-02-18 00:22:34','2019-02-18 00:22:34',NULL),(2,'TEST001',NULL,'Administrador',NULL,NULL,'admin@isuneon.com',NULL,'$2y$10$RBmiXjQSuzI.givrAvGIf.qohj5mK9a8jaFGGOB0CJkwQEXV9bhZa',NULL,NULL,1,NULL,'2019-02-18 03:35:39','2019-02-18 03:35:39',NULL);
